                                                ...
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <div class="space-y-4">
                                                        <h1 class="text-4xl fw-800"
                                                            ...
                                                            align="left">Order Cancellation Confirmation</h1>
                                                        ...
                                                        <p class=""
                                                            ...
                                                            align="left">Dear {{ $customer->name }}, <br> Your order
                                                            has been cancelled successfully. <br> The following items
                                                            will not be shipped:</p>
                                                        <table class="s-4 w-full" role="presentation" border="0"
                                                            cellpadding="0" cellspacing="0" style="width: 100%;"
                                                            width="100%">
                                                            <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <h3 class="text-center"
                                                                        ...
                                                                        align="center">Cancellation receipt from Bakery
                                                                        Store</h3>
                                                                            ...
                                                                            @foreach ($items as $item)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-right"
                                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;"
                                                                                        align="right" width="100%">
                                                                                        {{ $item->unit_price }}đ</td>
                                                                                    <td class="text-right"
                                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;"
                                                                                        align="right" width="100%">
                                                                                        {{ $item->quantity * $item->unit_price }}đ
                                                                                    </td>
                                                                                </tr>
                                                                            @endforeach
                                                                    ...
                                                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">If you have any questions,
                                                                        contact us at <a
                                                                            href="https://facebook.com/letruongtho2k2"
                                                                            style="color: #0d6efd;"><span
                                                                                class="__cf_email__"
                                                                                data-cfemail="8bc3e2fbc8e4f9fbcbeef3eae6fbe7eea5e8e4e6">Lê
                                                                                Trường Thọ</span></a>.</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
